  ...
  */
  ...
  export type WorksAggregateArgs = {
    ...
    **/
     ...
     * 
    **/
    orderBy?: Enumerable<WorksOrderByWithRelationInput>
    /**
  ...
  export type WorksGroupByArgs = {
    where?: WorksWhereInput
    orderBy?: Enumerable<WorksOrderByWithAggregationInput>
  ...
  type GetWorksGroupByPayload<T extends WorksGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type WorksGetPayload<
    ...
    P extends keyof Works ? Works[P] : never
  } 
    : Works
  : Works
  ...
  export interface WorksDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    /**
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Works'> extends True ? CheckSelect<T, Prisma__WorksClient<Works>, Prisma__WorksClient<WorksGetPayload<T>>> : CheckSelect<T, Prisma__WorksClient<Works | null, null>, Prisma__WorksClient<WorksGetPayload<T> | null, null>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Works'> extends True ? CheckSelect<T, Prisma__WorksClient<Works>, Prisma__WorksClient<WorksGetPayload<T>>> : CheckSelect<T, Prisma__WorksClient<Works | null, null>, Prisma__WorksClient<WorksGetPayload<T> | null, null>>
    ...
    **/
    ...
    /**
     * Find one Works that matches the filter or throw
     ...
     * })
    **/
    findUniqueOrThrow<T extends WorksFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, WorksFindUniqueOrThrowArgs>
    ): CheckSelect<T, Prisma__WorksClient<Works>, Prisma__WorksClient<WorksGetPayload<T>>>
     ...
     * })
    **/
    findFirstOrThrow<T extends WorksFindFirstOrThrowArgs>(
      args?: SelectSubset<T, WorksFindFirstOrThrowArgs>
    ): CheckSelect<T, Prisma__WorksClient<Works>, Prisma__WorksClient<WorksGetPayload<T>>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, WorksGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetWorksGroupByPayload<T> : PrismaPromise<InputErrors>
   ...
   */
  export class Prisma__WorksClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
  ...
  /**
   * Works base type for findUnique actions
   */
  export type WorksFindUniqueArgsBase = {
    /**
   ...
   * Works: findUnique
   */
  export interface WorksFindUniqueArgs extends WorksFindUniqueArgsBase {
   /**
  ...
  /**
   * Works base type for findFirst actions
   */
  export type WorksFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the Works
     * 
    **/
   ...
   * Works: findFirst
   */
  export interface WorksFindFirstArgs extends WorksFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
   ...
   */
  export type WorksFindUniqueOrThrowArgs = WorksFindUniqueArgsBase
      

  /**
   * Works: findFirstOrThrow
   */
  export type WorksFindFirstOrThrowArgs = WorksFindFirstArgsBase
  ...
  export type WorksWhereInput = {
    ...
    projectUrl?: StringFilter | string
  }
  ...
  export type WorksScalarWhereWithAggregatesInput = {
    ...
    projectUrl?: StringWithAggregatesFilter | string
  }
