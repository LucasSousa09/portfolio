...
interface AboutMeProps{
  aboutMeContainerRef: RefObject<HTMLDivElement>
}

export function AboutMe({aboutMeContainerRef}: AboutMeProps){
  return (
    <PageContainer id='about-me' pageContainerRef={aboutMeContainerRef}>
